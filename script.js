...
// ---You need to rewrite the following functions---
...
function existingDataBase(){
  return ["root@uci.edu", "admin@uci.edu"]
}
...
function doesTestPass (inputValues, outputValues) {
  ...
  result = result && !existingDataBase().includes(inputValues)
...
$(document).ready(function () {
  ...
  $('#existing-database').html(existingDataBase().join());
